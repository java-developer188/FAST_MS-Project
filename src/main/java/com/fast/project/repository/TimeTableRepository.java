...
public interface TimeTableRepository extends CrudRepository<TimeTable, Long> {
	...
	@Query("select tt.day,tt.time,tt.room,cst.course.fullName,cst.section.name,cst.teacher.fullName from TimeTable tt inner join tt.courseSectionTeacher cst , CSTStudent x where x.courseSectionTeacher.id = cst.id and x.student.id = :id")
